...
async function deploy() {
  ...
  for (let i = 1; i <= 3; i++) {
    ...
    const tokenUrljson = `https://indigo-tiny-aardvark-637.mypinata.cloud/ipfs/QmWDh7VU9rE3AD54PnmJCZBVCsBxNqZsELMhDU9rAHexMP/${i}.json`;
    ...
    const transactionawaitTx = transaction.wait();
    // console.log("transactionawaitTx:", transactionawaitTx);
